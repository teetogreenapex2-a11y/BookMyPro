...
export async function getBusinessInstructors(businessId: string, includeInactive = false) {
  return prisma.membership.findMany({
    where: {
      ...
      // Quick sandbox-invite placeholders (see sandbox-links/quick) are
      // not real team members - keep them out of both the booking picker
      // and the owner's own Team management list.
      isSandboxProspect: false,
    },
