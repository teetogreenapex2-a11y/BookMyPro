      ...
      <main style={{ maxWidth: 720, margin: "0 auto", padding: "22px 20px 60px" }}>
        ...
        {noteSlot && (
          <div ref={notePanelRef} style={{ background: "#FFF", border: "1px solid var(--border)", borderRadius: 12, padding: 16, marginTop: 16 }}>
            ...
            {bookingId ? (
              <>
                {noteSlot.bookedIsRemote && (
                  <a
                    href={`${basePath}/session/${bookingId}`}
                    style={{
                      display: "block", textAlign: "center", background: "var(--remote)", color: "#FFF",
                      borderRadius: 8, padding: "10px 14px", fontWeight: 700, fontSize: 13, textDecoration: "none", marginBottom: 12,
                    }}
                  >
                    Join session (video + Swing Sketch)
                  </a>
                )}
                {bookingContact && (
                  <div style={{
