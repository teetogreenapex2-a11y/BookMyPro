...
export async function POST(req: NextRequest, { params }: { params: { slug: string } }) {
  ...
  await sendPushToMembership(instructorMembershipId, {
    ...
    body: `${contactName?.trim() || "A player"} - billed separately - ${slot.startTime.toLocaleString(undefined, { weekday: "short", hour: "numeric", minute: "2-digit", timeZone: business.timezone })}`,
