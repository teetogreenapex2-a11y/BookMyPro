      ...
      {angles.map((a) => (
        <div
          ...
          style={{
            ...
            background: a.flagged ? "rgba(184,134,43,0.18)" : dark ? "rgba(255,255,255,0.1)" : "var(--card)",
            border: a.flagged ? "1px solid var(--gold)" : dark ? "1px solid rgba(255,255,255,0.25)" : "1px solid var(--border)",
            borderRadius: 8, padding: "5px 8px", opacity: a.uncertain ? 0.55 : 1,
          }}
        >
          <span style={{ fontSize: 15, fontWeight: 800, color: a.flagged ? "var(--gold)" : dark ? "#FFF" : "var(--fairway)", lineHeight: 1.3 }}>
